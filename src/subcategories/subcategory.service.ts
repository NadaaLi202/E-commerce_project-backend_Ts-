...
class SubcategoriesService {
  ...
  getAllSubcategories =  refactorService.getAll<Subcategories>(subcategorySchema);
  createSubcategory = refactorService.createOne<Subcategories>(subcategorySchema);
  getSubcategoryById = refactorService.getOneById<Subcategories>(subcategorySchema);
  updateSubcategory = refactorService.updateOne<Subcategories>(subcategorySchema);
  deleteSubcategory = refactorService.deleteOne<Subcategories>(subcategorySchema);
}
